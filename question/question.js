...
answer: `B. 2`,
explanation:`<p>Metode <em>Tall Man Lettering</em> digunakan untuk obat-obatan yang terdengar atau terlihat mirip (LASA/NORUM) dengan cara menggunakan <strong>huruf kapital</strong> pada bagian kata yang <strong>membedakan</strong> kedua nama obat tersebut, sementara bagian yang sama tetap menggunakan huruf kecil. Tujuannya adalah untuk menarik perhatian visual staf medis agar tidak salah mengambil obat. Pada kasus ini, bagian yang membedakan adalah "<strong><span style="color: #ff0000;">cis</span></strong>-" pada <strong>cisplatin</strong> dan "<span style="color: #ff0000;"><strong>carbo</strong></span>-" pada <strong>carboplatin</strong>. penulisan yang benar adalah <span style="color: #ff0000;">CIS</span>platin dan <span style="color: #ff0000;">CARBO</span>platin.</p><p><strong>Referensi:</strong></p><ol><li>Petunjuk Teknis Standar Pelayanan Kefarmasian di Rumah Sakit. Kementerian Kesehatan Republik Indonesia. 2019.</li></ol>`,
expImg:`9RTO1.PNG`
},
{
category:`Manajemen Farmasi`,
...
{
category:`Regulasi Praktik Kefarmasian `,
level:`Easy`,
...
answer: `E. VG89OPV`,
explanation:`<p>Berdasarkan PMK No. 12 Tahun 2017, vaksin sisa pada pelayanan statis memiliki <strong>batas masa pemakaian</strong> yang berbeda setelah vial dibuka:</p><ul><li><span style="color: #ff0000;">Polio (OPV)</span>: Maksimal <strong>2 minggu</strong> (±14 hari). Dari tanggal 14 Januari ke 04 Februari sudah melewati 21 hari (3 minggu), sehingga OPV tidak layak pakai.</li><li><span style="color: #ff0000;">IPV, DT, dan Hib</span>: Maksimal <strong>4 minggu</strong> (±28 hari). Ketiga vaksin ini baru dibuka selama 24-26 hari, sehingga masih dalam rentang masa pemakaian yang diperbolehkan.</li><li>Syarat lainnya (VVM A/B dan belum kedaluwarsa) sudah terpenuhi untuk semua item.</li></ul><p><strong>Referensi:</strong></p><ol><li>Peraturan Menteri Kesehatan Nomor 12 Tahun 2017 tentang Penyelenggaraan Imunisasi.</li></ol>`,
expImg:`12RTO1.PNG`
},
{
category:`Manajemen Farmasi`,
...
answer: `A. 135`,
explanation:`<p>Data yang diperlukan untuk merencanakan kebutuhan vaksin meliputi <span style="color: #ff0000;">jumlah sasaran</span>, <span style="color: #ff0000;">jumlah pemberian</span>, <span style="color: #ff0000;">target cakupan</span> dan i<span style="color: #ff0000;">ndeks pemakaian vaksin</span> dengan memperhitungkan <span style="color: #ff0000;">sisa vaksin (stok) sebelumnya</span>. Indeks Pemakaian (IP) vaksin adalah pemakaian rata-rata setiap kemasan vaksin. Cara menghitung IP adalah dengan membagi jumlah cakupan dengan jumlah vaksin yang dipakai.</p> <img src="assets/13PTO1.PNG"></img><p><strong>Referensi:</strong></p><ol><li>Kementerian Kesehatan RI. Direktorat Jenderal Kefarmasian dan Alat Kesehatan. Pedoman Pengelolaan Vaksin Di Fasilitas Pelayanan Kesehatan. 2021.</li></ol>`,
expImg:``
},
{
category:`Regulasi Praktik Kefarmasian `,
...
explanation:`<p>Suatu intervensi kesehatan dinyatakan <em>cost-effective</em> jika nilai ICER per QALY lebih kecil dari nilai <em>cost-effective threshold</em> (CET). Interpretasi nilai ICUR/ICER dengan PDB (GDP) menurut standar WHO dan Kemenkes:</p><ul><li>ICER <span style="color: #ff0000;">&lt; 1</span> PDB = Sangat <em>cost-effective</em></li><li>ICER <span style="color: #ff0000;">1 - 3</span> PDB = <em>Cost-effective</em></li><li>ICER <span style="color: #ff0000;">&gt; 3</span> PDB = Tidak <em>cost-effective</em></li></ul><p>Hitung nilai ICER/RIUB</p><img src="assets/1PTO2.PNG"></img><p><strong>Hitung Threshold</strong><br />Threshold = 3 x PDB = 3 x Rp83.700.000 = <strong>Rp251.100.000</strong><br /><br /><strong>Interpretasi:</strong> Karena nilai ICER (Rp330.000.000)<span style="color: #ff0000;"> &gt; Threshold</span> (Rp251.100.000), maka kesimpulannya adalah valsartan <span style="color: #ff0000;"><strong>tidak <em>cost-effective</em></strong></span> dibandingkan amlodipin.<br /><br /><strong>Referensi:</strong></p><ol><li>Kementerian Kesehatan RI. (2016). Pedoman Teknis Analisis Farmakoekonomi di Fasilitas Kesehatan.</li><li>Kementerian Kesehatan RI. (2025). Pedoman Kajian Farmakoekonomi dalam Pelayanan Kesehatan.</li></ol>`,
expImg:`1RTO2.PNG`
},
{
category:`Farmakoekonomi`,
...
explanation:`<img src="assets/2PTO2.PNG"></img><p>Berdasarkan <strong>tabel efektivitas-biaya</strong>, suatu intervensi kesehatan secara relatif terhadap intervensi kesehatan yang lain dapat dikelompokkan ke dalam <span style="color: #0000ff;">satu dari empat posisi</span>. Pada kasus ini: </p><ul><li><span style="color: #ff0000;"><strong>Regimen A</strong> </span>menawarkan <strong>efektivitas lebih tinggi</strong> dengan <strong>biaya lebih tinggi</strong> (<strong><span style="color: #3366ff;">masuk pada Kolom I</span></strong>).  </li><li><span style="color: #ff0000;"><strong>Regimen B</strong></span> menawarkan<strong> efektivitas yang lebih rendah</strong> dengan <strong>biaya yang lebih rendah</strong> pula (<span style="color: #3366ff;"><strong>masuk pada Kolom A</strong></span>).</li></ul><p>Kondisi ini masuk ke dalam kategori <strong>posisi ke-4</strong>, maka untuk melakukan pemilihan perlu memperhitungkan <strong>RIEB (Rasio Inkremental Efektivitas-Biaya)</strong>.</p><p><strong>Referensi:</strong><br />Kementerian Kesehatan RI. 2013. Pedoman Penerapan Kajian Farmakoekonomi. Jakarta: Kementerian Kesehatan RI.</p>`,
expImg:``
},
{
category:`Farmakoepidemiologi`,
...
answer: `B. 24`,
explanation:`<img src="assets/3PTO2.PNG"></img><p>NNH = 24, artinya 24 orang harus diterapi dengan OAINS baru untuk menambah 1 angka insiden perdarahan saluran cerna dibandingkan dengan OAINS standar.<br /><br /><em>Number Needed to Harm</em> (NNH) = Jumlah orang yang perlu terpapar untuk menghasilkan insiden penyakit. Semakin tinggi NHH, semakin baik.<br /><br /><strong>Referensi:</strong><br />Centers for Disease Control and Prevention. (2012). Principles of epidemiology in public health practice: An introduction to applied epidemiology and biostatistics (3rd ed.). U.S. Department of Health and Human Services.</p>`,
expImg:`3RTO2.PNG`
},
{
category:`Farmakoepidemiologi`,
level:`Easy`,
question:`Seorang apoteker di bagian QA <i>Pharmacovigilance</i> industri farmasi PT Nitro Pharmaceutical sedang menyusun <i>Periodic Safety Update Report</i> (PSUR) untuk produk antiplatelet baru. Sebagai bagian dari evaluasi efikasi pasca-pemasaran, apoteker menganalisis data studi klinis fase IV untuk melihat efektivitas obat dalam mencegah infark miokard berulang selama 2 tahun dibandingkan dengan terapi standar. Data yang diperoleh adalah sebagai berikut: <img src="assets/4STO2.PNG"></img>Berapakah nilai <i>Relative Risk Reduction</i> (RRR) pada kasus tersebut?`,
img:``,
...
explanation:`<p>Penggunaan obat <span style="color: #ff0000;">di luar Formularium Rumah Sakit</span> hanya dimungkinkan setelah mendapat <strong>rekomendasi dari Ketua KFT</strong> dengan <strong>persetujuan Direktur/Kepala Rumah Sakit</strong>. Pengajuan ini dilakukan dengan mengisi formulir permintaan obat khusus non-formularium dan diberikan dalam <span style="color: #ff0000;">jumlah terbatas sesuai kebutuhan</span>.<br /><br /><strong>Referensi:</strong><br />Kementerian Kesehatan RI. 2020. Keputusan Menteri Kesehatan Nomor HK.01.07/MENKES/200/2020 tentang Pedoman Penyusunan Formularium Rumah Sakit.</p>`,
expImg:`5RTO2.PNG`
},
{
category:`Manajemen Farmasi`,
...
explanation:`<p>Berdasarkan Permenkes Nomor 5 Tahun 2019, institusi swasta (termasuk apotek) yang<strong> bekerja sama dengan BPJS Kesehatan</strong> <span style="color: #ff0000;">wajib</span> melakukan pengadaan obat melalui prosedur <span style="color: #ff0000;"><em>e-purchasing</em></span> berdasarkan <strong>Katalog Elektronik</strong>. Program Rujuk Balik (PRB) merupakan <span style="color: #0000ff;">bagian dari pelayanan JKN</span>, sehingga pengadaan obatnya wajib mengikuti sistem tersebut untuk menjamin transparansi dan efektivitas biaya operasional program.<br /><br /><strong>Referensi:</strong></p><ol><li>Kementerian Kesehatan RI (2019). Petunjuk Teknis Standar Pelayanan Kefarmasian di Rumah Sakit. Jakarta: Direktorat Jenderal Kefarmasian dan Alat Kesehatan.</li><li>Peraturan Menteri Kesehatan Nomor 5 Tahun 2019 tentang Perencanaan dan Pengadaan Obat Berdasarkan Katalog Elektronik.</li></ol>`,
expImg:`7RTO2.PNG`
},
{
category:`Manajemen Farmasi`,
...
answer: `D. 7 hari`,
explanation:`<p>Apabila pemesanan dilakukan <strong>secara elektronik</strong>, <span style="color: #0000ff;"><strong>surat pesanan manual (asli)</strong> </span>harus diterima oleh pemasok selambat-lambatnya<span style="color: #ff0000;"> 7 (tujuh) hari</span> setelah adanya pemberitahuan secara elektronik dari pihak pemasok bahwa pesanan elektronik telah diterima.<br /><br /><strong>Referensi:</strong><br />Peraturan BPOM No. 24 Tahun 2021 tentang Pengawasan Pengelolaan Obat, Bahan Obat, Narkotika, Psikotropika, dan Prekursor Farmasi di Fasilitas Pelayanan Kefarmasian.</p>`,
expImg:`8RTO2.PNG`
},
{
category:`Manajemen Farmasi`,
level:`Easy`,
question:`Seorang apoteker di depo farmasi rawat inap RS Nitro Medica sedang melakukan kegiatan <i>labeling</i> dan penyiapan cairan elektrolit sebelum disalurkan ke unit perawatan pasien. Apoteker harus memastikan setiap sediaan yang termasuk dalam kategori <i>High-Alert Medication</i> (HAM) diberikan stiker label berwarna mencolok agar tidak terjadi kesalahan pengambilan atau pemberian oleh perawat. Saat itu, terdapat 5 jenis sediaan cairan yang sedang disiapkan: <img src="assets/9STO2.PNG"></img>Apakah sediaan farmasi yang wajib diberikan stiker <i>label High-Alert</i> oleh apoteker tersebut? (UKOMNAS PDPA Maret 2026)`,
img:``,
options:["A. 1","B. 2","C. 3","D. 4","E. 5"],
answer: `D. 4`,
explanation:`<p><span style="color: #ff0000;"><strong>Magnesium Sulfat (MgSO4) 40%</strong> </span>termasuk dalam kategori Elektrolit Konsentrasi Tertentu yang merupakan bagian dari H<em>igh-Alert Medication</em> (HAM). <span style="color: #0000ff;">Elektrolit konsentrat</span> maupun <span style="color: #0000ff;">konsentrasi tertentu</span> <strong>wajib</strong> diberi penandaan/stiker <em>High-Alert</em> karena risiko fatal yang tinggi jika terjadi kesalahan dosis atau kecepatan pemberian.<br /><br /><strong>Referensi:</strong></p><ol><li>Institute for Safe Medication Practices (ISMP). (2024). ISMP List of High-Alert Medications in Acute Care Settings. ISMP Medication Safety Alert! Acute Care, Volume 29, Issue 1.</li><li>Kementerian Kesehatan RI (2019). Petunjuk Teknis Standar Pelayanan Kefarmasian di Rumah Sakit. Jakarta: Direktorat Jenderal Kefarmasian dan Alat Kesehatan.</li></ol>`,
expImg:`9RTO2.PNG`
},
{
category:`Manajemen Farmasi`,
...
explanation:`<p>Berdasarkan Permenkes No. 5 Tahun 2023 Pasal 65 ayat (3), Berita Acara Pemusnahan dibuat dalam <strong><span style="color: #ff0000;">rangkap 3 (tiga)</span></strong>. Lembar <strong>pertama</strong> disimpan sebagai a<strong>rsip internal fasilitas</strong>, sedangkan <span style="background-color: #ffff00;">tembusannya</span> disampaikan kepada <span style="color: #ff0000;">Kementerian Kesehatan (Direktorat Jenderal terkait)</span> <strong>dan</strong> <span style="color: #0000ff;">Kepala BPOM (atau unit pelaksana teknis BPOM setempat</span>).<br /><br /><strong>Referensi:</strong><br />Peraturan Menteri Kesehatan No. 5 Tahun 2023 tentang Narkotika, Psikotropika, dan Prekursor Farmasi.</p>`,
expImg:`10RTO2.PNG`
},
{
category:`Manajemen Farmasi`,
...
explanation:`<ol><li><span style="color: #ff0000;"><strong>Limbah Infeksius:</strong></span> Untuk limbah infeksius, benda tajam, dan patologis yang disimpan pada <strong>suhu 3°C sampai 8°C</strong>, batas waktu penyimpanannya adalah <strong>maksimal 7 hari</strong>.</li><li><span style="color: #0000ff;"><strong>Limbah Farmasi:</strong></span> Untuk limbah B3 kategori farmasi yang dihasilkan <strong>&lt; 50 kg per hari</strong>, batas waktu penyimpanan paling lama adalah <strong>180 hari</strong> sejak limbah dihasilkan.</li></ol><p><strong>Referensi:</strong><br />Peraturan Menteri Kesehatan Republik Indonesia Nomor 7 Tahun 2019 tentang Kesehatan Lingkungan Rumah Sakit</p>`,
expImg:`11RTO2.PNG`
},
{
category:`Manajemen Farmasi`,
level:`Easy`,
question:`Apoteker di Instalasi Farmasi Dinas Kesehatan Kota menerima pengiriman logistik vaksin yang akan digunakan untuk program imunisasi rutin. Saat barang tiba, data pemantau suhu menunjukkan adanya lonjakan suhu hingga 30°C selama beberapa jam akibat kerusakan unit pendingin pada armada pengiriman. Apoteker melakukan identifikasi terhadap risiko kerusakan sediaan berdasarkan data logistik berikut: <img src="assets/12STO2.PNG"></img>Apakah vaksin yang paling berisiko mengalami kerusakan pada kondisi tersebut?`,
img:``,
options:["A. DPT-HB-Hib","B. Hepatitis B","C. IPV","D. MR","E. Td"],
answer: `D. MR`,
explanation:`<p>Berdasarkan penggolongan sensitivitas suhu, vaksin dibagi menjadi dua:</p><ol><li><strong>Vaksin Sensitif Panas (<em>Heat Sensitive</em>)</strong>: Golongan ini akan rusak jika terpapar panas berlebih. Contohnya adalah <span style="color: #ff0000;">BCG, Polio (OPV), Campak, dan<strong> MR</strong></span>.</li><li><strong>Vaksin Sensitif Beku (<em>Freeze Sensitive</em>)</strong>: Golongan ini akan rusak jika terpapar suhu dingin di bawah 0 derajat Celcius (beku). Contohnya adalah <span style="color: #0000ff;">Hepatitis B, DPT-HB-Hib, DPT-HB, IPV, DT, TT, dan Td</span>.</li></ol><p><strong>Referensi:</strong><br />Peraturan Menteri Kesehatan Nomor 12 Tahun 2017 tentang Penyelenggaraan Imunisasi</p>`,
expImg:`12RTO2.PNG`
},
{
category:`Manajemen Farmasi`,
level:`Easy`,
question:`Pada tanggal 04 Februari 2026 pukul 15.00 WIB, apoteker di puskesmas melakukan audit kelayakan sisa vaksin multi-dose dari pelayanan statis. Apoteker melakukan pemisahan terhadap sediaan yang sudah tidak layak digunakan agar tidak terambil saat pelayanan imunisasi berdasarkan data hasil pemeriksaan sebagai berikut: <img src="assets/13STO2.PNG"></img>Apakah vaksin yang sudah tidak dapat digunakan kembali pada pelayanan tersebut?`,
img:``,
options:["A. VG03MMR","B. VG17HIB","C. VG45HepB","D. VG89IPV","E. VG89OPV"],
answer: `A. VG03MMR`,
explanation:`<p>Berdasarkan PMK No. 12 Tahun 2017, vaksin sisa pada pelayanan statis memiliki batas masa pemakaian yang berbeda setelah vial dibuka atau dilarutkan:</p><ul><li><strong>MMR</strong>: Hanya dapat digunakan <span style="color: #ff0000;">maksimal 6 jam setelah dilarutkan</span>. Pada kasus ini, vaksin dilarutkan pukul 08.00 WIB dan audit dilakukan pukul 15.00 WIB (sudah 7 jam), sehingga VG03MMR sudah tidak layak pakai.</li><li><strong>Polio (OPV)</strong>: <span style="color: #ff0000;">Maksimal 2 minggu (±14 hari)</span>. Dari 28 Januari ke 04 Februari baru berjalan 7 hari (masih layak).</li><li><strong>IPV, Hib, dan HepB (DPT-HB-Hib)</strong>: <span style="color: #ff0000;">Maksimal 4 minggu (±28 hari)</span>. Ketiga vaksin ini baru dibuka selama 10-20 hari, sehingga masih dalam rentang masa pemakaian yang diperbolehkan.</li></ul><p><strong>Referensi:</strong><br />Peraturan Menteri Kesehatan Nomor 12 Tahun 2017 tentang Penyelenggaraan Imunisasi.</p>`,
expImg:``
},
{
category:`Manajemen Farmasi`,
...
answer: `A. 1, 2, dan 3`,
explanation:`<ol><li><strong>Obat kategori <span style="color: #ffffff; background-color: #ff0000;">Merah</span></strong> adalah obat-obatan yang <span style="color: #ff0000;">harus selalu tersedia</span> dalam jumlah yang cukup di IGD tanpa harus diresepkan: <span style="color: #0000ff;">Adrenalin, Sulpat Atropin, Kortikosteroid, Lidokain, Dextrose 50%, Aminophilin, Dopamin, Dobutamin, dan lain-lain</span>.</li><li><strong>Obat kategori <span style="background-color: #ffff00;">Kuning</span></strong> adalah obat-obatan yang <span style="color: #ff0000;">harus selalu tersedia</span> dalam jumlah yang cukup di IGD tanpa harus diresepkan: <span style="color: #0000ff;">Analgetik, Cairan Kristaloid, Anti Rabies, Anti Bisa Ular, dan lain-lain</span>.</li><li><strong>Obat kategori <span style="background-color: #00ff00;">Hijau</span></strong> adalah obat-obatan yang <span style="color: #ff0000;">dapat diresepkan melalui apotek RS</span> jika tidak tersedia di IGD:<span style="color: #0000ff;"> Beta Blokker, dan lain-lain</span>.</li></ol><p>Obat yang semuanya masuk <span style="color: #ff0000;">kategori merah</span> adalah <span style="color: #ff0000;"><strong>Adrenalin (1), Aminophilin (2), dan Dextrose 50% (3)</strong></span><br /><br /><strong>Referensi:</strong><br />Petunjuk Teknis Standar Pelayanan Kefarmasian di Rumah Sakit. Kementerian Kesehatan Republik Indonesia. 2019.</p>`,
expImg:`14RTO2.PNG`
},
{
category:`Regulasi Praktik Kefarmasian `,
...
explanation:`<p><strong><em>Confidentiality</em></strong> (menjaga rahasia) menuntut apoteker untuk melindungi informasi medis pasien dari pihak yang tidak berwenang. Pada kasus ini, tindakan apoteker membawa pasien ke ruang konseling tertutup untuk menghindari orang lain (rekan kerja) mengetahui identitas obat maupun kondisi medis pasien adalah penerapan dari perlindungan privasi.</p><p><strong>Etika Profesi:</strong></p><ol><li><em>Veracity</em> = Jujur</li><li><em>Non-Maleficence</em> = Cegah Bahaya</li><li><em>Beneficence</em> = Proaktif atau Pelayanan Maksimal</li><li><em>Confidentiality</em> = Menjaga Rahasia</li><li><em>Fairness or Social Responsible</em> = Adil</li><li><em>Autonomy</em> = Menghargai Keputusan Pasien</li><li><em>Fidelity (Loyalty)</em> = Menepati Janji</li></ol><p><strong>Referensi:</strong><br />Beauchamp, T. L., &amp; Childress, J. F. (2019). Principles of biomedical ethics (8th ed.). Oxford University Press.</p>`,
expImg:``
},
{
category:`Manajemen Farmasi`,
...
answer: `B. 92,6%`,
explanation:`<p>Nilai <em>performance</em> adalah salah satu dari tiga faktor utama dalam perhitungan <em>Overall Equipment Effectiveness</em> (OEE) yang mengukur seberapa efektif mesin bekerja selama waktu operasinya dibandingkan dengan kecepatan maksimal yang dirancang (kecepatan ideal).</p><ul><li>Kecepatan 90 tablet/detik</li><li>Waktu kualifikasi 8 jam x 3600 detik = 28.800 detik</li><li>Kapasitas teoritis 90 tablet/detik x 28.800 detik = 2.592.000 tablet</li><li>Output aktual = 2.400.000 tablet</li><li>Output teoritis = 2.592.000 tablet</li><li>Performance = (2.400.000 tablet/2.592.000 tablet) x 100%</li><li>Performance = 92,6%</li></ul><p><strong>Referensi:</strong><br />Zubair (2021).Manufacturing productivity analysis by apply-ing overall equipment effectiveness metric in a pharmaceutical industry. Congent engineering</p>`,
expImg:`01M34.png`
},
{
category:`Industri Farmasi`,
level:`Medium`,
question:`<p>Sebuah mesin <em>Fluid Bed Dryer</em> (FBD) beroperasi selama 8 jam dengan down time (waktu henti) selama 30 menit, selama shift berjalan terdapat waktu istirahat selama 60 menit, serta setelah mesin beroperasi selama 4 jam terjadi penurunan suhu pengeringan, sehingga mesin perlu diperbaiki oleh engineering selama 45 menit. Berapakah nilai <em>availabillity</em> dari mesin <em>Fluid Bed Dryer</em> tersebut?</p>`,
img:``,
...
category:`Industri Farmasi`,
level:`Medium`,
question:`Bagian produksi akan melakukan proses filling sirup kedalam 306.000 botol. Mesin filling yang digunakan memiliki 10 nozzle (head) yang bekerja secara paralel. Berdasarkan hasil kualifikasi waktu yang dibutuhkan untuk mengisi satu botol adalah 5 detik per botol per nozzle. Berapa waktu yang dibutuhkan untuk mesin menyelesaikan proses filling?`,
img:``,
...
answer: `B. 98,2%`,
explanation:`<b>1. Menghitung Volume yang Hilang (Loss)</b><p>Kita identifikasi semua volume yang tidak menjadi produk jadi:</p><ul><li><strong>Tumpahan:</strong> 1 L</li><li><strong>Sisa Pipa (Dead Volume):</strong> 14 L</li><li><strong>Reject Botol:</strong> 50 botol &times; 60 mL = 3.000 mL = 3 L</li></ul><p><b>Total Volume Hilang: </b>1 + 14 + 3 = 18 L </p><br/><b>2. Menghitung Volume Produk Jadi (Actual Yield)</b><p>Volume produk jadi adalah volume teoritis dikurangi total volume yang hilang:</p><ul><li><strong>Volume Teoritis:</strong> 1.000 L</li><li><strong>Volume Aktual:</strong> 1.000 L - 18 L = 982 L</li></ul><br/><b>3. Menghitung % Yield</b><p>Rumus dan perhitungan % yield adalah sebagai berikut:</p><ul><li><strong>Rumus:</strong> <span class="math">% Yield = (Volume Aktual / Volume Teoritis) &times; 100%</span></li><li><strong>Perhitungan:</strong> <span class="math">% Yield = (982 Liter / 1.000 Liter) &times; 100%</span></li><li><strong>Proses:</strong> <span class="math">% Yield = 0,982 &times; 100%</span></li><li><strong>Hasil Akhir:</strong> <strong style="color: #27ae60; font-size: 1.1em;">98,2%</strong></li></ul>`,
expImg:``
},
{
category:`Industri Farmasi`,
...
answer: `B. 99,05%`,
explanation:`<ul><li>Massa inti 100 kg</li><li>Target weight gain : 5% dari massa inti (100 kg x 5%) = 5 kg</li><li>Massa teoritis = 100kg + 5 kg= 105 kg</li><li>Massa aktual = 104kg</li><li>%yield = (massa aktual/massa teoritis)%yield = (104 kg / 105 kg)%yield = 99,05%</li></ul><p><strong>Referensi:<br /></strong>Pedoman CPOB 2018 (BPOM R) Dalam Bab 5: Produksi</p>`,
expImg:``
},
{
category:`Industri Farmasi`,
...
explanation:`<p>Validasi proses adalah upaya untuk mengetahui apakah proses produksi sudah dapat menghasilkan produk yang sesuai standar mutu secara konsisten. Tahapan validasi proses adalah sebagai berikut:</p><ul><li><strong>Pembuatan protokol validasi</strong><br />Setelah batch record suatu produk dibuat oleh bagian RnD, departemen QA akan melakukan assesment terkait <em>Critical Procecces Parameter</em> (CPP) selama proses produksi seperti suhu ,waktu, dan kapasitas dari granulator. Setelah itu QA akan menyusun protokol validasi proses.</li></ul><ul><li><strong>Pelaksanaan validasi proses</strong><br />Departemen QA akan bekerja sama dengan departemen produksi untuk menjalankan proses produksi pada 3 batch skala produksi dan semua parameter kritis (CPP) dipantau sesuai dengan protokol untuk melihat terdapat deviasi atau tidak.<br /><br />Departemen QA akan berkoordinasi dengan departemen QC untuk memeriksa produk yang dihasilkan menggunakan proses yang divalidasi untuk mengetahui sudah sesuai dengan standar mutu atau tidak. Setelahnya departemen QA akan mengolah data yang diperoleh secara statistik, sehingga diperoleh Cp (Capability Process) yang menunjukkan potensi dan presisi dari proses yang divalidasi dan memasuki rentang dari batas atas dan batas bawah. Selain itu juga diperoleh Cpk yang menunjukkan hasil aktual dari proses yang divalidasi yang tidak hanya melihat konsistensi dari proses tapi akurasi dari proses. Umumnya di industri farmasi besar setelah proses validasi akan dilakukan proses verifikasi on going sehingga akan diperoleh data Pp/Ppk yang merupakan versi continue dari Cp/Cpk.</li></ul><p>Berdasarkan PerBPOM No 15 tahun 2023, pemindahan lokasi proses produksi termasuk registrasi mayor karena di lokasi berbeda menggunakan mesin yang berbeda yang mempunyai hasil kualifikasi yang berbeda serta perbedaan lokasi pabrik dapat mempengaruhi parameter lingkungan.</p><ul><li>Persyaratan BPOM terkait validasi proses pada registrasi mayor jika hanya terdapat data skala pilot.</li><li>Diperbolehkan menyertakan data validasi dari satu batch skala pilot.</li><li>Harus melampirkan komitmen untuk melakukan validasi tiga batch skala produksi pertama.</li><li>Komitmen harus mencantumkan prediksi waktu pelaporan data validasi.</li><li>Produk tidak boleh diedarkan sebelum komitmen validasi dipenuhi.</li></ul><p><strong>Referensi:<br /></strong>PerBPOM No 15 tahun 2023 Perubahan Keempat Atas Peraturan Kepala Badan Pengawas Obat dan Makanan Nomor 24 Tahun 2017 tentang Kriteria dan Tata Laksana Registrasi Obat</p>`,
expImg:`08M34.png`
},
{
category:`Industri Farmasi`,
...
img:``,
options:["A. Cetrimide agar","B. Eosin methylene blue agar","C. Mannitol salt agar","D. Mueller Hinton agar","E. Xylose lysine deoxycholate agar"],
answer: `A. Cetrimide agar`,
...
{
category:`Teknologi Sediaan Solid`,
level:`Easy`,
...
{
category:`Teknologi Sediaan Liquid`,
level:`Hard`,
...
{
category:`Teknologi Sediaan Semisolid`,
level:`Hard`,
...
category:`Teknologi Sediaan Steril`,
level:`Hard`,
question:`<p>Bagian <em>Quality Assurance</em> (QA) PT Nitro Pharmaceutical melakukan uji batas endotoksin menggunakan metode jendal gel (<em>gel-clot</em>) terhadap sediaan injeksi antibiotik. Diketahui sensitivitas reagen LAL (λ) adalah 0,125 EU/mL. Berikut data hasil pengujian:</p><table style="width: 461px;"><tbody><tr style="height: 13px;"><td style="width: 73px; height: 13px;"><strong>Larutan</strong></td><td style="width: 162.25px; height: 13px;"><strong>Keterangan</strong></td><td style="width: 229.75px; height: 13px;"><strong>Hasil Uji</strong></td></tr><tr style="height: 13px;"><td style="width: 73px; height: 13px; text-align: center;">A </td><td style="width: 162.25px; height: 13px; text-align: left;"> Sampel</td><td style="width: 229.75px; height: 13px;">Replikasi 1: Positif (+)<br />Replikasi 2: Negatif (-)</td></tr><tr style="height: 13px;"><td style="width: 73px; height: 13px; text-align: center;">B </td><td style="width: 162.25px; height: 13px; text-align: left;"> Kontrol Positif Produk</td><td style="width: 229.75px; height: 13px;">Replikasi 1: Positif (+)<br />Replikasi 2: Positif (+)</td></tr><tr style="height: 13px;"><td style="width: 73px; height: 13px; text-align: center;">C </td><td style="width: 162.25px; height: 13px; text-align: left;"> Kontrol Positif Reagen</td><td style="width: 229.75px; height: 13px;">Positif (+) pada 2λ, λ, dan 0,5λ<br />Negatif (-) pada 0,25λ</td></tr><tr style="height: 13px;"><td style="width: 73px; height: 13px; text-align: center;">D </td><td style="width: 162.25px; height: 13px; text-align: left;"> Kontrol Negatif</td><td style="width: 229.75px; height: 13px;">Replikasi 1: Positif (-)<br />Replikasi 2: Negatif (-)</td></tr></tbody></table><p>Apakah interpretasi yang paling tepat dari hasil pengujian tersebut?</p>`,
img:``,
...
category:`Teknologi Sediaan Semisolid`,
level:`Hard`,
question:`Apoteker QC di PT Nitro Pharmaceutical mengevaluasi stabilitas fisik emulsi o/w minyak ikan. Data hasil pengujian:<img src="assets/M08-08.jpg"></img>Formula manakah yang memiliki risiko koalesensi paling tinggi?`,
img:``,
...
explanation:`<p>Penggunaan bersamaan antara <span style="color: #ff0000;">lamotrigin</span> dan<span style="color: #ff0000;"> kontrasepsi hormonal kombinasi</span> dapat <strong>menurunkan kadar serum lamotrigin secara signifikan</strong>, yaitu sekitar 40% hingga 64%. Penurunan kadar ini dapat menyebabkan kontrol kejang menjadi tidak adekuat dan memicu terjadinya <span style="color: #0000ff;">kekambuhan kejang</span> (<em>breakthrough seizures</em>). Sebaliknya, saat minggu bebas pil (<em>pill-free week</em>), kadar lamotrigin dapat meningkat kembali hingga dua kali lipat, yang berisiko menimbulkan efek samping toksisitas.<br /><br /><strong>Referensi:</strong><br />Baxter, K. (Ed). Stockley’s Drug Interactions 9th Edition. Pharmaceutical Press.</p>`,
expImg:`9RTO9.PNG`
},
{
category:`Penyakit Kulit`,
level:`Easy`,
question:`<p>Seorang bayi laki-laki usia 8 bulan dibawa ibunya ke apotek dengan keluhan bercak kemerahan pada area popok. Berdasarkan anamnesis, bayi tersebut sedang mengalami diare dan jarang dilakukan penggantian popok. Hasil pengamatan menunjukkan adanya <em>patch</em> eritematosa dengan batas mengikuti bentuk konveks popok, namun daerah lipatan (<em>fleksural</em>) tampak bersih. Ibu pasien meminta saran sediaan topikal untuk melindungi kulit bayinya. Apakah pilihan terapi topikal yang memberikan efek proteksi pada kasus tersebut?</p>`,
img:`11STO9.PNG`,
options:["A. Dekspantenol","B. Hidrokortison","C. Ketokonazol","D. Mupirosin","E. Nistatin"],
answer: `A. Dekspantenol`,
explanation:`<p>Berdasarkan kriteria diagnostik klinis dari PPK PERDOSKI 2024, kemunculan <span style="color: #ff0000;">bercak merah</span> <em>(patch</em> eritematosa) yang hanya mengenai area konveks popok (daerah yang bersentuhan langsung dengan popok) dengan area lipatan/fleksural yang tetap bersih <em>(sparing)</em> merupakan tanda khas dari <span style="color: #ff0000;"><strong>Dermatitis Popok Iritan</strong></span>. Kondisi ini dipicu oleh iritasi kronis akibat <span style="color: #0000ff;">kelembapan, urin, dan feses</span>.<br /><br /><strong>Penatalaksanaan meliputi:</strong></p><ol><li><strong>Tatalaksana Umum (Non-medikamentosa):</strong> Menggunakan protokol ABCDE (<em>Air out, Barrier, Clean, Diaper, Education</em>).</li><li><strong>Terapi Medikamentosa Topikal:</strong> Penggunaan agen <em>Barrier</em> (protektan) sebagai terapi utama untuk melindungi kulit dari iritan eksternal. <strong>Dekspantenol</strong> dikategorikan sebagai terapi medikamentosa topikal yang bersifat protektif (sebagai salep/ointment) dan mendukung proses <em>re-epitelisasi</em> jaringan kulit yang rusak.</li></ol><p><strong>Referensi:</strong><br />Perhimpunan Dokter Spesialis Kulit dan Kelamin Indonesia. (2024). Panduan praktik klinis bagi dokter spesialis dermatologi dan venereologi Indonesia tahun 2024. PERDOSKI.</p>`,
expImg:`11RTO9.PNG`
},
{
category:`Pelayanan Farmasi Klinis`,
...
answer: `C. Probable`,
explanation:`<p>Berdasarkan standar penilaian Algoritma Naranjo, interpretasi skor untuk menentukan derajat kepastian (kausalitas) efek samping obat adalah sebagai berikut:</p><ol><li><strong>Skor 0 atau kurang:</strong> <em>Doubtful</em> (Ragu-ragu)</li><li><strong>Skor 1 - 4:</strong> <em>Possible</em> (Cukup mungkin)</li><li><strong>Skor 5 - 8:</strong> <em>Probable</em> (Mungkin)</li><li><strong>Skor 9 atau lebih:</strong> <em>Highly Probable</em> (Sangat mungkin)</li></ol><p>Total skor yang diperoleh apoteker <strong>adalah 8</strong>, maka kejadian tersebut dikategorikan sebagai <span style="color: #ff0000;"><strong><em>Probable</em> (Mungkin)</strong></span> disebabkan oleh obat yang dicurigai.<br /><br /><strong>Referensi:</strong><br />Kementerian Kesehatan RI. 2019. Petunjuk Teknis Standar Pelayanan Kefarmasian di Rumah Sakit. Jakarta: Direktorat Jenderal Kefarmasian dan Alat Kesehatan.</p>`,
expImg:`4RTO9.PNG`
},
{
category:`Pelayanan Farmasi Klinis`,
...
explanation:`<p><strong>Itrakonazol</strong> adalah p<strong>enghambat kuat enzim <span style="color: #ff0000;">CYP3A4</span></strong><span style="color: #ff0000;">.</span> <strong>Simvastatin</strong> merupakan<span style="color: #ff0000;"> substrat utama enzim tersebut</span>. Interaksi ini menyebabkan<strong> peningkatan kadar serum simvastatin</strong> secara signifikan (bisa meningkat hingga lebih dari 10 kali lipat), yang memicu efek toksik berupa <span style="color: #ff0000;"><strong>rhabdomyolysis</strong></span>. Gejala klinisnya ditandai dengan <span style="color: #0000ff;">nyeri otot hebat <em>(myalgia)</em> dan urin berwarna gelap (<em>myoglobinuria</em>)</span>.<br /><br /><strong>Referensi:</strong><br />Baxter, K. (Ed). Stockley’s Drug Interactions 9th Edition. Pharmaceutical Press.</p>`,
expImg:`10RTO9.PNG`
},
{
category:`Penyakit Kulit`,
...
explanation:`<p>Berdasarkan panduan PPK PERDOSKI 2024, terapi skabies untuk bayi usia di bawah 2 bulan menggunakan <strong><span style="color: #ff0000;">Sulfur 5-10%</span></strong>. Instruksi penggunaan adalah:</p><ul><li><strong>Durasi aplikasi: </strong>Sediaan <strong>dioleskan</strong> ke <span style="color: #0000ff;">seluruh tubuh</span> dan <span style="color: #0000ff;">didiamkan selama 8 jam</span>.</li><li><strong>Frekuensi: </strong>Prosedur ini <strong>dilakukan</strong><span style="color: #0000ff;"> selama 3 malam berturut-turut</span>.</li></ul><p><strong>Referensi:</strong><br />Perhimpunan Dokter Spesialis Kulit dan Kelamin Indonesia. (2024). Panduan praktik klinis bagi dokter spesialis dermatologi dan venereologi Indonesia tahun 2024. PERDOSKI.</p>`,
expImg:`12RTO9.PNG`
},
{
category:`Penyakit infeksi`,
level:`Medium`,
question:`Seorang dokter di rumah sakit meminta rekomendasi apoteker mengenai terapi untuk pasien perempuan (usia kehamilan 27 minggu) yang didiagnosis mengalami sistitis. Berdasarkan hasil uji kultur urine, diketahui bahwa infeksi tersebut disebabkan oleh bakteri <em>Escherichia coli</em>. Apoteker perlu memilihkan terapi yang efektif sekaligus aman untuk kondisi kehamilan pasien. Apakah antibiotik yang tepat direkomendasikan?`,
img:``,
options:["A. Cefixime","B. Amoxicillin","C. Kotrimoksazole","D. Fosfomycin","E. Nitrufurantoin"],
answer: `D. Fosfomycin`,
explanation:`<p><strong>Fosfomisin</strong> merupakan<span style="color: #ff0000;"><strong> lini pertama</strong></span> untuk sistitis non komplikata yang disebabkan oleh bakteri gram negatif serta<strong> E. coli</strong> menunjukkan tingkat sensitivitas yang sangat tinggi terhadap Fosfomisin, bahkan untuk galur yang sudah resisten terhadap antibiotik lain (seperti ESBL).Selain itu fosfomisin hanya diberikan dalam dosis tunggal 3 gram sehingga meningkatkan kepatuhan<br /><br /><strong>Nitrofurantoin</strong> juga efektif untuk terapi definitif E.coli akan tetapi nitrofurantoin perlu dikonsumsi 100 mg 3x sehari selama satu minggu dimana pada pasien ini yang <span style="color: #ff0000;">mendekati trimester ketiga (minggu 28)</span> terapi menggunakan nitrofurantoin <strong>defisiensi G6PD</strong> dan <strong>risiko anemia hemolitik</strong> serta <strong>risiko teratogenik</strong> pada bayi<br /><br /><strong>Cefixime</strong> memiliki keamanan FDA B dan efektif terhadap E coli,akan tetapi antibiotik ini spektrum luas,sehingga kurang tepat bila digunakan untuk terapi definitif untuk E coli dan dapat memicu resistensi antibiotik di masa depan dan lebih berisiko mengganggu flora normal<br /><br /><strong>Amoxicillin</strong> memiliki kemanan FDA B pada ibu hamil,akan tetapi sama seperti cefixime antibiotik ini memiliki spektrum kerja yang luas dan angka resistensi E. coli terhadap golongan penisilinterus meningkat secara global dan lokal di Indonesia<br /><br /><strong>Kotrimoxazole</strong> aman untuk trimester 2,akan tetapi memiliki kasus yang sama seperti nitrofurantoin karena pasien mendekat TM3 . Penggunaan kotrimoxazole untuk sistitis adalah 5-7 hari sehingga penggunaan kotrimoxazole di TM3 meningkatkan risiko kernikterus/bayi kuning dan neural tube defect</p><p><strong>Referensi:</strong><br />Kemenkes.(2025). PEDOMAN NASIONAL PELAYANAN KLINIS TATA LAKSANA INFEKSI SALURAN KEMIH</p>`,
expImg:`Fosfomisin.png`
},
{
category:`Penyakit infeksi`,
level:`Hard`,
question:`Seorang pasien, laki-laki, usia 32 tahun, dengan riwayat HIV datang ke IGD dengan keluhan sakit kepala hebat, kejang, dan penurunan kesadaran. Hasil pemeriksaan uji TORCH menunjukkan pasien terinfeksi Toxoplasma gondii disertai dengan penumpukan cairan pada otak. Dokter akan meresepkan obat tambahan untuk mengurangi edema tersebut agar tekanan intrakranial pasien tidak meningkat lebih lanjut. Apakah obat yang tepat untuk mengatasi kondisi tersebut? (TO UKOMNAS PDPA Januari 2026)`,
img:``,
options:["A. Pirimetamin","B. Sulfadiazine","C. Furosemide","D. Dexametasone","E. Mannitol"],
answer: `D. Dexametasone`,
explanation:`<p>Dalam kasus <em>Toxoplasmic Encephalitis</em> (TE) pada pasien HIV, sering terjadi pembentukan abses atau lesi yang menyebabkan <em>edema vasogenik</em> (kebocoran cairan dari pembuluh darah ke jaringan otak). <strong>Kortikosteroid,</strong> khususnya <span style="color: #ff0000;">Dexametasone</span>, adalah terapi adjuvant yang sangat penting untuk mengurangi peradangan dan edema di sekitar lesi tersebut. Hal ini bertujuan untuk menurunkan <em>mass effect</em> (efek massa) yang menekan jaringan otak sehat dan menurunkan tekanan intrakranial (TIK).<br /><br /><strong>Referensi:</strong><br />DiPiro's Pharmacotherapy: A Pathophysiologic Approach, 12th Edition</p>`,
expImg:`Toxoplasma.png`
},
{
category:`Penyakit infeksi`,
level:`Medium`,
question:`<p>Seorang pasien, perempuan, usia 63 tahun, telah menderita katarak selama lebih dari 5 tahun dan akan menjalani operasi katarak. Dokter spesialis mata meminta rekomendasi apoteker untuk menyiapkan antibiotik profilaksis berbentuk tetes mata untuk pasien tersebut agar tidak terjadi <em>endoftalmitis</em> pascaoperasi. Apakah antibiotik yang tepat direkomendasikan?</p>`,
img:``,
options:["A. Gentamisin","B. Kloramfenikol","C. Eritromisin","D. Amoxicillin","E. Moxifloxacin"],
answer: `E. Moxifloxacin`,
explanation:`<p><strong>Moxifloxacin</strong> merupakan floroquinolon generasi keempat yang memiliki spektrum yang luas dan efektif membunuh bakteri Gram-positif (seperti <em>Staphylococcus epidermidis</em> dan <em>Staphylococcus aureus</em> yang merupakan flora normal kelopak mata dan penyebab utama endoftalmitis pasca operasi serta memiliki penetrasi cairan bola mata (bilik mata depan/anterior chamber) yang sanga baik dibandingkan antibiotik lain.Golongan florokuinolon generasi lama seperti levofloksasin cukup efektif jg untuk profilaksis endoftalmitis akan tetapi penetrasinya ke cairan bola mata tidak sebaik dari florokuinolon generasi keempat seperti moxifloxacin<br /><br /><strong>Gentamisin</strong> sangat kuat melawan bakteri Gram-negatif, namun aktivitasnya terhadap bakteri Gram-positif (penyebab utama endoftalmitis) tidak sebaik fluorokuinolon.<br /><br /><strong>Eritromisin</strong> berbentuk salep mata umumnya digunakan untuk infeksi superfisial atau sebagai profilaksis ophthalmia neonatorum pada bayi baru lahir. Penetrasi eritromisin ke dalam bilik mata depan sangat lemah<br /><br /><strong>Kloramfenikol</strong> efektivitas penetrasinya dan profil resistensinya tidak lebih baik daripada Fluoroquinolone<br /><br /><strong>Amoxicillin</strong> Merupakan antibiotik sistemik. Untuk profilaksis bedah mata, rute topikal (tetes) atau intrakameral lebih diutamakan<br /><br /><strong>Referensi:</strong><br />Bratzler DW, Dellinger EP, Olsen KM, Perl TM, Auwaerter PG, Bolon MK, et al. Clinical practice guidelines for antimicrobial prophylaxis in surgery. Am J Health Syst Pharm. 2013;70(3):195-283. doi: 10.2146/ajhp120568.</p>`,
expImg:`Moxifloxacin.png`
},
{
category:`Penyakit infeksi`,
level:`Hard`,
question:`Seorang pasien dijadwalkan untuk operasi pembedahan tulang pada pukul 10.00 pagi dan direncanakan akan diberikan cefazolin intravena sebagai antibiotik profilaksis. Manakah waktu paling tepat untuk pemberian cefazolin intravena agar agar mencapai kadar puncak saat insisi kulit dilakukan? (TO UKOMNAS PDPA Januari 2026)`,
img:``,
options:["A. 08.00 – 08.30","B. 08.30 – 09.00","C. 09.00 – 09.30","D. 09.30 – 10.00","E. 10.00 – 10.30"],
answer: `D. 09.30 – 10.00`,
explanation:`<p><strong>Cefazolin</strong> membutuhkan waktu sekitar <span style="color: #ff0000;"><strong>30 menit setelah injeksi intravena</strong> </span>untuk terdistribusi secara maksimal ke jaringan lunak dan tulang. Dengan memberikan obat pada pukul 09.00 - 09.30, kadar obat dalam darah dan jaringan akan berada pada titik tertinggi saat pisau bedah menyentuh kulit pada pukul 10.00. Cefazolin dipilih sebagai profilaksis untuk operasi bedah terutama pada bedah tulang karena Sefazolin memiliki kemampuan untuk masuk ke dalam jaringan lunak dan jaringan tulang dengan sangat baik serta kompatibel dengan zat anastetik yang digunakan<br /><br /><strong>Referensi:</strong><br />PERATURAN MENTERI KESEHATAN REPUBLIK INDONESIA NOMOR 28 TAHUN 2021 TENTANG PEDOMAN PENGGUNAAN ANTIBIOTIK</p>`,
expImg:`Cefazolin.png`
},
{
category:`Penyakit infeksi`,
level:`Easy`,
question:`Seorang pasien, laki-laki, usia 35 tahun, terdiagnosis infeksi laten tuberkulosis setelah dilakukan tes Mantoux. Hasil foto rontgen dada pasien normal dan tidak ada gejala klinis tuberkulosis aktif. Setelah dilakukan penelusuran, pasien diketahui tinggal bersama istrinya yang merupakan penderita tuberkulosis aktif. Dokter meminta rekomendasi apoteker mengenai pengobatan profilaksis untuk pasien tersebut. Apakah regimen pengobatan yang tepat direkomendasikan? (TO UKOMNAS PDPA Januari 2026)`,
img:``,
...
category:`Penyakit infeksi`,
level:`Easy`,
question:`<p>Seorang pasien, perempuan, usia 26 tahun, dengan usia kehamilan 22 minggu, dibawa ke IGD rumah sakit dengan keluhan diare cair menyerupai air cucian beras lebih dari 10 kali dalam 6 jam terakhir. Pasien tampak lemas, mata cekung, dan turgor kulit kembali sangat lambat. Hasil kultur feses pasien mengonfirmasi adanya infeksi Vibrio cholerae. Dokter meminta rekomendasi apoteker untuk memberikan terapi antibiotik yang aman bagi pasien tersebut. Apakah antibiotik yang tepat direkomendasikan? (TO UKOMNAS PDPA Januari 2026) </p>`,
img:``,
options:["A. Doksisiklin","B. Azithromicin","C. Tetrasiklin","D. Siprofloksasin","E. Amoxicillin"],
answer: `B. Azithromicin`,
explanation:`<p><strong>Azitromisin</strong> adalah obat lini pertama untuk ibu hamil dan anak-anak yang menderita kolera. Azitromisin masuk dalam Kategori B pada kehamilan (studi pada hewan tidak menunjukkan risiko, studi pada manusia belum memadai tapi dianggap aman). Selain aman, Azitromisin dosis tunggal sangat efektif dalam mengurangi durasi diare dan volume tinja pada infeksi Vibrio cholerae.<br /><br /><strong>Doksisiklin:</strong> Doksisiklin sebenarnya adalah lini pertama untuk kolera pada orang dewasa non-hamil. Namun, pada ibu hamil, Doksisiklin masuk dalam Kategori D. Penggunaan golongan tetrasiklin pada trimester kedua dan ketiga berisiko menyebabkan diskolorisasi gigi permanen pada janin dan mengganggu pertumbuhan tulang (osteogenesis).<br /><br /><strong>Tetrasiklin:</strong> Sama seperti Doksisiklin, Tetrasiklin masuk dalam Kategori D dan sangat dihindari untuk ibu hamil karena efek toksik pada jaringan keras janin (gigi dan tulang) serta potensi hepatotoksisitas pada ibu.<br /><br /><strong>Siprofloksasin:</strong> Golongan fluoroquinolone (Kategori C) umumnya dihindari pada kehamilan karena adanya kekhawatiran terhadap kerusakan tulang rawan sendi (arthropathy) pada janin. Meskipun dalam keadaan darurat tertentu bisa dipertimbangkan, Azitromisin tetap jauh lebih aman dan menjadi prioritas utama.<br /><br /><strong>Amoxicillin:</strong> Meskipun Amoxicillin sangat aman untuk ibu hamil (Kategori B), obat ini tidak efektif melawan Vibrio cholerae. Bakteri ini secara alami memiliki tingkat resistensi yang tinggi terhadap golongan penisilin, sehingga Amoxicillin tidak digunakan dalam protokol terapi kolera.<br /><br /><strong>Referensi:</strong><br />KONSENSUS NASIONAL PENATALAKSANAAN DIARE PADA PASIEN DEWASA DI INDONESIA TAHUN 2024</p>`,
expImg:`KoleraBumil.png`
},
{
category:`Penyakit infeksi`,
level:`Hard`,
question:`<p>Seorang pasien, perempuan, usia 30 tahun, sedang mengonsumsi antibiotik untuk mengobati infeksi yang dideritanya. Sehari setelah meminum antibiotik tersebut, pasien mengonsumsi minuman beralkohol. Tak lama kemudian, pasien mengalami mual hebat, muntah, wajah memerah (<em>flushing</em>), jantung berdebar cepat, dan sakit kepala berdenyut. Dokter di IGD mendiagnosis pasien mengalami <em>disulfiram-like reaction</em> akibat interaksi antibiotik dan alkohol. Apakah antibiotik yang dikonsumsi oleh pasien tersebut?</p>`,
img:``,
options:["A. Amoxicillin","B. Eritromisin","C. Siprofloksasin","D. Metronidazole","E. Doksisiklin"],
answer: `D. Metronidazole`,
explanation:`<p>Reaksi yang terjadi diakibatkan oleh interaksi antara metronidazol dan alkohol/etanol yang disebut <em>disulfiram-like reaction</em>.Reaksi ini terjadi karena gangguan pada metabolisme alkohol (etanol) di dalam hati. Berikut adalah tahapan normal metabolisme alkohol:<br /><br /><strong>Mekanisme Penghambatan:</strong> Metronidazole bekerja dengan cara menghambat enzim Asetaldehida Dehidrogenase (ALDH) secara reversibel.<br /><br /><strong>Akumulasi Toksik:</strong> Akibat penghambatan ini, asetaldehida dari alkohol tidak dapat diubah menjadi asam asetat dan menumpuk di dalam darah hingga kadar yang toksik.<br /><br /><strong>Gejala Klinis:</strong> Penumpukan asetaldehida inilah yang memicu gejala sistemik berupa wajah memerah panas (<em>flushing</em>), mual-muntah hebat, denyut jantung cepat (<em>palpitasi/takikardia</em>), sesak napas, dan hipotensi.<br /><br /><strong>Referensi:</strong><br />Stockley : Drug Interaction</p>`,
expImg:`InteraksiMetronidazole.png`
},
{
category:`Penyakit infeksi`,
level:`Hard`,
question:`<p>Seorang pasien, laki-laki, usia 24 tahun, datang ke klinik dengan keluhan diare berlemak dan perut kembung setelah mengonsumsi air sungai saat mendaki gunung. Hasil pemeriksaan mikroskopis feses pasien mengonfirmasi adanya infeksi Giardia lamblia. Pasien diketahui memiliki riwayat reaksi anafilaksis terhadap obat golongan nitroimidazol. Dokter meminta rekomendasi apoteker untuk menentukan terapi alternatif yang aman bagi pasien tersebut. Apakah obat yang tepat direkomendasikan?</p>`,
img:``,
options:["A. Metronidazole","B. Albendazole","C. Siprofloksasin","D. Tinidazole","E. Doksisiklin"],
answer: `B. Albendazole`,
explanation:`<p><strong>Albendazole</strong> adalah anggota golongan benzimidazole yang terbukti efektif sebagai alternatif untuk terapi Giardiasis ketika pasien tidak dapat mentoleransi golongan nitroimidazole.Obat ini bekerja dengan menghambat polimerisasi tubulin pada parasit, yang mengganggu pengambilan glukosa dan menyebabkan kematian sel parasit.<br /><br /><strong>Metronidazole</strong> dan <strong>tinidazole</strong> tidak dapat digunakan pada pasien tersebut karena kedua obat tersebut termasuk kedalam golongan nitroamidazole.<br /><br />Golongan <strong>Florokuinolon,</strong> digunakan untuk infeksi bakteri, bukan <strong>Giardiasis.</strong><br /><br /><strong>Siprofloksasin:</strong> Golongan fluoroquinolone (Kategori C) umumnya dihindari pada kehamilan karena adanya kekhawatiran terhadap kerusakan tulang rawan sendi (arthropathy) pada janin. Meskipun dalam keadaan darurat tertentu bisa dipertimbangkan, Azitromisin tetap jauh lebih aman dan menjadi prioritas <strong>utama.</strong><br /><br /><strong>Doksisiklin</strong> memiliki aktivitas penghambatan terhadap sintesis protein pada beberapa protozoa, namun efikasinya terhadap Giardia lamblia secara in vivo (pada manusia) dianggap tidak konsisten jika dibandingkan dengan obat lini pertama.<br /><br /><strong>Referensi:</strong><br />DiPiro's Pharmacotherapy: A Pathophysiologic Approach, 12th Edition</p>`,
expImg:`Albendazole.png`
},
{
category:`Penyakit infeksi`,
level:`Easy`,
question:`<p>Seorang pasien, bayi perempuan baru lahir, ditetapkan memiliki risiko tinggi penularan HIV karena ibunya baru terdiagnosis saat persalinan dan belum pernah mendapat terapi antiretroviral (ART). Ibu pasien berencana untuk tetap memberikan ASI. Dokter meminta rekomendasi apoteker mengenai regimen profilaksis antiretroviral (ARV) pascapersalinan untuk bayi tersebut. Apakah regimen profilaksis ARV yang tepat direkomendasikan?</p>`,
img:``,
...
explanation:`<p>Digunakan <em>double teraphy</em> karena menyusui adalah paparan virus yang terjadi terus-menerus setiap hari. Kombinasi dua obat (AZT + NVP) memberikan tingkat hambatan replikasi virus yang lebih kuat dibandingkan hanya satu obat, sehingga dapat menangkal virus yang mungkin masuk melalui ASI selama periode awal yang paling rentan.<br /><br />Opsi A ,B dan C: Pemberian dosis tunggal (<em>single dose</em>) tidak lagi direkomendasikan karena tidak memberikan perlindungan yang adekuat terhadap paparan virus terus-menerus selama masa menyusui.<br /><br />Penggunaan tiga jenis obat ARV (<em>Triple Therapy</em>) pada bayi merupakan regimen terapi (ART) untuk bayi yang sudah terdiagnosis positif HIV, bukan merupakan profilaksis pascapersalinan.<br /><br /><strong>Referensi:</strong><br />PEDOMAN NASIONAL PELAYANAN KEDOKTERAN TATA LAKSANA HIV. 2019</p>`,
expImg:`profilaksishiv.png`
},
{
category:`Penyakit infeksi`,
level:`Easy`,
question:`<p>Seorang pasien, anak laki-laki, usia 9 tahun, dibawa ke rumah sakit dengan keluhan demam dan dehidrasi. Keluarga pasien mengatakan gejala tersebut muncul setelah pasien mengonsumsi menu lele dari program makan siang di sekolahnya. Hasil uji kultur sampel makanan dan feses pasien menunjukkan positif mengandung bakteri <em>Salmonella typhi</em>. Dokter mendiagnosis pasien mengalami demam tifoid dan meminta rekomendasi apoteker untuk terapi antibiotik oral lini pertama pasien tersebut. Apakah antibiotik yang tepat direkomendasikan?</p>`,
img:``,
...
category:`Penyakit infeksi`,
level:`Medium`,
question:`<p>Seorang pasien, laki-laki, usia 45 tahun, yang tinggal di pedalaman Papua, datang ke rumah sakit dengan keluhan pembengkakan kronis pada tungkai kanan bawah sejak 6 bulan yang lalu. Hasil pemeriksaan darah mengonfirmasi adanya mikrofilaria Wuchereria bancrofti dengan densitas tinggi. Dokter di puskesmas sebelumnya telah memberikan terapi standar kombinasi dietilkarbamazin dan albendazol, namun respons pembersihan mikrofilaria belum optimal. Berdasarkan pedoman tata laksana terbaru di wilayah endemik, dokter ingin mengoptimalkan terapi dengan menambahkan satu agen antiparasit lain ke dalam regimen tersebut (membentuk <em>Triple Therapy</em>) dan meminta rekomendasi apoteker. Apakah obat tambahan yang tepat direkomendasikan?</p>`,
img:``,
options:["A. Doksisiklin","B. Ivermektin","C. Kortikosteroid","D. Kotrimoksazol","E. Mebendazol"],
answer: `B. Ivermektin`,
explanation:`<p>Menurut standar pengobatan filariasis, pemberian Ivermectin ditujukan sebagai mikrofilarisida yang sangat efektif untuk menurunkan jumlah mikrofilaria dalam darah secara cepat. Kombinasi tiga obat (Triple Therapy: DEC + Albendazole + Ivermectin) telah terbukti mempercepat eliminasi parasit dimana mekanisme kerja Triple Therapy (IDA) adalah sebagai berikut:</p><ol><li>Ivarmectin memicu hiperpolarisasi dan kelumpuhan mikrofilaria melalui pembukaan saluran ion klorida</li><li>Diethylcarbamazine (DEC) mengubah permukaan tubuh parasit agar mudah dihancurkan sistem imun inang serta mengganggu metabolisme asam arakidonatnya</li><li>Albendazole menghambat polimerisasi mikrotubulus yang mengakibatkan kegagalan penyerapan glukosa dan kematian parasit akibat kekurangan energi.</li></ol><p><strong>Referensi:<br /></strong>Guideline Alternatives Mass Drug Administration Regimen to Eliminate Lymphatic Filiarisis, WHO, 2017</p>`,
expImg:`Filiarisis.png`
},
{
category:`Penyakit infeksi`,
level:`Medium`,
question:`<p>Seorang pasien, perempuan, usia 28 tahun, datang ke klinik dengan keluhan gatal hebat, rasa terbakar, dan keputihan berwarna putih kental pada area vagina. Pasien melaporkan bahwa keluhan ini merupakan kejadian yang ke-5 kalinya dalam 12 bulan terakhir. Sebelumnya, pasien selalu sembuh setelah menggunakan antijamur topikal berupa ovula, namun gejala selalu muncul kembali. Pasien dipastikan tidak memiliki riwayat diabetes melitus dan tidak sedang hamil. Dokter mendiagnosis pasien mengalami kandidiasis vulvovaginal berulang dan meminta rekomendasi apoteker untuk terapi antijamur oral pasien tersebut. Apakah obat yang tepat direkomendasikan?</p>`,
img:``,
options:["A. Clotrimazole","B. Fluconazole","C. Metronidazol","D. Nistatin","E. Mikonazol"],
answer: `B. Fluconazole`,
explanation:`<p>Berdasarkan analisis kasus tersebut pasien mengalami <em>Kandidiasis Vulvovaginal</em> (VVC) diklasifikasikan sebagai <em>rekuren</em> (RVVC) karena terjadi 4 kali atau lebih episode simtomatik dalam satu tahun. Digunakan <strong>Flukonazol</strong> karena mampu berpenetrasi dengan sangat baik ke dalam cairan dan jaringan vagina, memastikan kadar terapeutik tercapai tepat di lokasi infeksi dan bekerja spesifik <strong><span style="color: #ff0000;">menghambat</span></strong> enzim sitokrom P450 jamur (yang menghentikan konversi <strong>lanosterol</strong> menjadi <strong>ergosterol</strong> menyebabkan integritas sel membran dari Candida albicans bocor.<br /><br /><strong>Clotrimazole, Nistatin, &amp; Mikonazol:</strong> Merupakan antijamur topikal/intravaginal yang efektif untuk episode akut non-komplikata, namun tidak menjadi pilihan utama untuk rejimen pemeliharaan jangka panjang pada kasus rekuren.<br /><br /><strong>Metronidazol:</strong> Merupakan antibiotik/antiprotozoa yang digunakan untuk mengobati Bacterial Vaginosis atau Trichomoniasis, bukan untuk infeksi jamur Candida.<br /><br /><strong>Referensi:</strong><br />Panduan Praktik Klinis Dermatologi Venereologi, Perdoski, 2024</p>`,
expImg:`Kandidasis.png`
},
{
category:`Penyakit infeksi`,
level:`Medium`,
question:`<p>Seorang pasien, laki-laki, usia 62 tahun, dibawa ke rumah sakit dengan keluhan sesak napas, batuk berdahak berwarna karat, dan demam tinggi sejak 2 hari yang lalu. Pasien diketahui memiliki riwayat diabetes melitus tipe 2 dan memiliki kebiasaan mengonsumsi alkohol secara rutin. Berdasarkan hasil pemeriksaan foto rontgen toraks, dokter mendiagnosis pasien mengalami pneumonia komunitas (<em>Community Acquired Pneumonia</em>/CAP). Dokter meminta rekomendasi apoteker mengenai terapi antibiotik empiris tunggal yang tepat untuk pasien tersebut. Apakah antibiotik yang tepat direkomendasikan?</p>`,
img:``,
options:["A. Doksisiklin","B. Ceftriaxone","C. Azithromisin","D. Levofloksasin","E. Amoxicillin"],
answer: `D. Levofloksasin`,
explanation:`<p>Berdasarkan analisis kasus tersebut pasien mengalami didiagnosis <strong>CAP disertai komorbid</strong> dimana dapat diberikan monoterapi florokuinolon (Levofloksasin/Moxifloxacin) atau Terapi Kombinasi (Beta-laktam + Makrolida/Doksisiklin). Alasan Memilih Levofloksasin karena Levofloksasin memiliki spektrum luas yang mencakup bakteri tipikal (seperti <em>S. pneumoniae</em> yang resisten penisilin) dan bakteri atipikal. Pada pasien alkoholisme, risiko infeksi bakteri Gram-negatif seperti<em> Klebsiella pneumoniae</em> meningkat, dan kuinolon memiliki efikasi yang baik terhadap patogen tersebut.<br /><br /><strong>Analisis opsi lain:</strong> Opsi Amoksisilin, Ceftriaxone, Azithromisin dan Doksisiklin hanya ditujukan untuk pasien CAP tanpa komorbiditas (sehat) dan tanpa faktor risiko resistensi. Pada pasien diabetes dan alkoholisme, risiko kegagalan terapi dengan monoterapi ini sangat tinggi.<br /><br /><strong>Referensi:</strong><br />PNPK Tatalaksana Pneumonia pada Dewasa, KMK no. 2147 / 2023</p>`,
expImg:`CAPKomorbid.png`
},
{
category:`Penyakit infeksi`,
level:`Medium`,
question:`<p>Seorang pasien, laki-laki, usia 34 tahun, datang ke klinik dengan keluhan diare berat berupa buang air besar encer lebih dari 4 kali dalam 24 jam, disertai kram perut hebat dan mual. Gejala tersebut muncul setelah pasien baru saja kembali dari perjalanan wisata ke India. Hasil pemeriksaan feses tidak menunjukkan adanya darah. Dokter mendiagnosis pasien mengalami <em>traveler's diarrhea</em> non-disentri dan meminta rekomendasi apoteker mengenai terapi antibiotik empiris untuk pasien tersebut. Apakah antibiotik yang tepat direkomendasikan?</p>`,
img:``,
options:["A. Siprofloksasin","B. Kotrimoksazol","C. Doksisilin","D. Azithromisin","E. Metronidazol"],
answer: `D. Azithromisin`,
explanation:`<p>Berdasarkan analisis kasus tersebut pasien mengalami <em><strong>travel diarrhea</strong> </em>dimana brdasarkan pedoman, <span style="color: #ff0000;"><strong>Azitromisin</strong></span> adalah obat pilihan utama untuk <em>Traveler's Diarrhea</em> yang terjadi di wilayah dengan risiko<strong> resistensi kuinolon</strong> yang tinggi atau jika diare bersifat berat/disentri dimana Azitromisin efektif melawan <em>Campylobacter</em> yang resisten terhadap fluoroquinolone dan juga efektif terhadap patogen enterik lainnya seperti <em>E. coli.</em><br /><br /><strong>Analisis opsi lain:</strong></p><ul><li><strong>Siprofloksasin:</strong> Di wilayah Asia Selatan (termasuk India/Prindavan) dan Asia Tenggara, bakteri Campylobacter merupakan penyebab umum diare dan telah menunjukkan tingkat resistensi yang sangat tinggi terhadap golongan Flurokuinolon (seperti Siprofloksasin).<br /><br /></li><li><strong>Kotrimoksazol</strong> : Tidak lagi direkomendasikan secara rutin karena tingkat resistensi patogen usus yang sudah meluas secara global.<br /><br /></li><li><strong>Doksisiklin:</strong> Terkadang digunakan untuk pencegahan kolera, namun bukan merupakan standar terapi untuk Traveler's Diarrhea umum karena efektivitasnya yang rendah.<br /><br /></li><li><strong>Metronidazole:</strong> Digunakan untuk diare akibat protozoa (seperti Giardia atau Amoeba), namun tidak efektif untuk diare bakteri yang merupakan penyebab sebagian besar kasus traveler's diarrhea akut.</li></ul><p><strong>Referensi:</strong><br />Dipiro 12th Edition</p>`,
expImg:`Traveldiarrhea.png`
},
{
category:`Penyakit infeksi`,
level:`Easy`,
question:`<p>Seorang pasien, laki-laki, usia 35 tahun, datang ke klinik dengan keluhan kurap yang gatal dan meluas di area dada, perut, hingga ke kedua pahanya. Pasien mengatakan sebelumnya telah mengobati keluhan tersebut dengan krim mikonazol secara rutin selama 3 minggu, namun area infeksi justru semakin menyebar. Dokter mendiagnosis pasien mengalami <em>tinea corporis</em> ekstensif dan meminta rekomendasi apoteker mengenai terapi antijamur oral untuk pasien tersebut. Apakah obat yang tepat direkomendasikan?</p>`,
img:``,
options:["A. Ciclopirox","B. Terbinafin","C. Flukonazol","D. Amfoterisin B","E. Griseofulvin"],
answer: `B. Terbinafin`,
explanation:`<p>Berdasarkan analisis kasus tersebut pasien menderita <strong><em>Tinea Corporis</em></strong> yang bersifat meluas (<em>extensive</em>), sehingga penggunaan antijamur oral (sistemik) diperlukan karena infeksi sudah menyebar luas ke beberapa area tubuh (dada, perut, paha) dan telah gagal dengan pengobatan topikal (krim <strong>miconazole)</strong> selama <strong>3 minggu.</strong><br /><br /><strong>Terbinafin</strong> merupakan <strong><span style="color: #ff0000;">lini pertama</span> </strong>untuk infeksi dermatofit sistemik. Terbinafin bersifat fungisidal (membunuh jamur) dengan menghambat enzim skualen epoksidase, yang mengakibatkan kematian sel jamur lebih cepat dibandingkan agen fungistatik.<br /><br /><strong>Analisis opsi lain:</strong></p><ul><li><strong>Ciclopirox:</strong> Umumnya digunakan untuk tine oncoris (infeksi jamur di kuku) dan tersedia dalam bentuk topikal (krim/kutek kuku). Tidak efektif untuk kasus yang memerlukan penanganan sistemik karena luasnya infeksi.<br /><br /></li><li><strong>Amfoterisin</strong> <strong>B</strong>: Merupakan antijamur sistemik yang sangat kuat dengan toksisitas tinggi, dicadangkan hanya untuk infeksi jamur sistemik yang mengancam nyawa (seperti meningitis kriptokokus), bukan untuk jamur kulit biasa<br /><br /></li><li><strong>Flukonazol:</strong> Lebih efektif untuk infeksi Candida (ragi). Meskipun bisa digunakan untuk tinea, efikasinya terhadap jamur dermatofit seringkali di bawah Terbinafin.br&gt;<br />Griseofulvin: Merupakan antijamur sistemik lini lama. Meskipun bisa digunakan, Griseofulvin bersifat fungistatik dan memerlukan durasi pengobatan yang jauh lebih lama (4–6 minggu) dibandingkan Terbinafin.</li></ul><p><strong>Referensi:</strong><br />Panduan Praktik Klinis Dermatologi Venereologi, Perdoski, 2021</p>`,
expImg:`Tineacorporis.png`
},
{
category:`Penyakit infeksi`,
level:`Hard`,
question:`<p>Seorang pasien, laki-laki, usia 40 tahun, dengan riwayat HIV/AIDS dirawat di rumah sakit karena didiagnosis mengalami meningitis kriptokokus. Pasien mendapatkan terapi induksi antijamur melalui infus intravena. Sesaat setelah pemberian infus dimulai, pasien mengalami reaksi akut berupa demam, menggigil, dan gemetar hebat. Hasil pemeriksaan laboratorium setelah beberapa hari terapi juga menunjukkan adanya hipokalemia dan hipomagnesemia. Apoteker mengidentifikasi bahwa kondisi tersebut merupakan efek samping dari obat antijamur yang diberikan. Apakah obat yang dimaksud?</p>`,
img:``,
options:["A. Flukonazol","B. Terbinafin","C. Itraconazol","D. Amfoterisin B","E. Griseofulvin"],
answer: `D. Amfoterisin B`,
explanation:`<p><strong>Amfoterisin B</strong> adalah <span style="color: #ff0000;"><strong>lini pertama</strong> </span>untuk fase induksi pada meningitis kriptokokus karena spektrumnya yang sangat luas dan sifatnya yang fungisidal kuat.<br /><br />Amfoterisin B dikenal sering menyebabkan reaksi yang disebut "<em>shake and bake</em>", yaitu demam, menggigil, dan gemetar hebat sesaat setelah infus diberikan. Hal ini disebabkan oleh pelepasan sitokin pro-inflamasi.Selain itu lah satu efek samping yang paling khas dari Amfoterisin B adalah <strong>nefrotoksisitas,</strong> yang secara spesifik menyebabkan kebocoran elektrolit di tubulus ginjal. Hal ini mengakibatkan pasien mengalami <strong>hipokalemia</strong> dan <strong>hipomagnesemia</strong> yang signifikan.<br /><br />Untuk pencegahan efek samping tersebut biasanya untuk s<em>hake and bake reaction</em> dipremedikasi dengan <strong>antipiretik</strong> atau <strong>antihistamin,</strong> sementara <strong>hipokalemia</strong> dicegah dengan pemberian hidrasi<strong> cairan salin (NaCl 0,9%)</strong> serta suplemen kalium.<br /><br /><strong>Referensi:</strong><br />WHO Guidelines. Diagnosis, Prevention and Management of Cryptococcal Disease.</p>`,
expImg:``
},
{
category:`Penyakit infeksi`,
level:`Hard`,
question:`<p>Seorang pasien, laki-laki, usia 58 tahun, dengan riwayat diabetes melitus tipe 2 yang tidak terkontrol, datang ke rumah sakit dengan keluhan luka gangren pada telapak kaki kanan yang berbau busuk dan bernanah. Hasil pemeriksaan fisik dan radiologi mengonfirmasi adanya infeksi berat yang melibatkan jaringan lunak hingga ke tulang (<em>osteomielitis</em>). Pasien memiliki riwayat alergi berat (<em>anafilaksis</em>) terhadap antibiotik golongan penisilin. Dokter meminta rekomendasi apoteker mengenai terapi antibiotik yang tepat bagi pasien tersebut mengingat adanya riwayat alergi beta-laktam. Apakah antibiotik yang tepat direkomendasikan?</p>`,
img:``,
...
{
category:`Gangguan kardiovaskuler`,
level:`Medium`,
...
answer: `A. Nitropusside`,
explanation:`<p><strong>Hipertensi urgensi:</strong> tekanan darah 180/120mmHg tanpa kerusakan organ. <br /><strong>Terapi:</strong> antihipertensi oral kerja pendek seperti kaptopril, klonidin, labetolol.</p><p><strong>Hipertensi emergensi:</strong> tekanan darah 180/120mmHg disertai kerusakan organ. <br /><strong>Terapi:</strong> Nitropusside (vasodilator yang bekerja langsung menurunkan pulmonary vascular resistance).<br /><br /><strong>Referensi:</strong><br />Dipiro ed 12 th halaman 128</p>`,
expImg:``
},
{
category:`Gangguan kardiovaskuler`,
level:`Medium`,
question:`<p>Seorang pasien, perempuan, usia 24 tahun, dibawa ke IGD karena mengalami penurunan kesadaran 2 jam setelah mengonsumsi sejumlah tablet alprazolam. Hasil pemeriksaan menunjukkan pasien tampak mengantuk namun dapat dibangunkan dengan rangsangan verbal. Tanda-tanda vital pasien meliputi tekanan darah 110/70 mmHg, nadi 84 kali/menit, frekuensi napas 18 kali/menit, dan saturasi oksigen 98%. Dokter meminta rekomendasi apoteker mengenai antidotum spesifik yang dapat diberikan untuk mengatasi kondisi tersebut. Apakah antidotum yang tepat direkomendasikan?</p>`,
img:``,
...
category:`Gangguan kardiovaskuler`,
level:`Medium`,
question:`<p>Seorang pasien, perempuan, usia 55 tahun, datang ke apotek dengan keluhan nyeri kepala dan badan terasa tidak nyaman. Pasien rutin mengonsumsi simvastatin 20 mg setiap malam untuk menurunkan kadar kolesterol. Berdasarkan hasil pemeriksaan laboratorium terbaru, diperoleh data kadar kolesterol total 300 mg/dL, LDL 180 mg/dL, dan HDL 40 mg/dL. Apoteker menilai bahwa target penurunan kadar LDL belum tercapai meskipun pasien sudah patuh menggunakan simvastatin, sehingga diperlukan penambahan terapi obat untuk mengendalikan kadar kolesterol pasien tersebut. Apakah obat tambahan yang tepat direkomendasikan?</p>`,
img:``,
...
category:`Gangguan kardiovaskuler`,
level:`Medium`,
question:`<p>Seorang apoteker melakukan visite bersama dokter di ruang rawat inap untuk mengevaluasi terapi obat pada pasien, laki-laki, usia 50 tahun, dengan hipertensi tanpa komorbid. Hasil pemeriksaan menunjukkan tekanan darah pasien saat ini adalah 170/105 mmHg. Dokter berencana memberikan terapi kombinasi dua jenis antihipertensi untuk membantu mencapai target tekanan darah yang diinginkan. Apakah kombinasi dua jenis antihipertensi yang tepat direkomendasikan?</p>`,
img:``,
options:["A. ACE inhibitor + ARB","B. ACE inhibitor + CCB","C. ARB + Beta blocker","D. Beta blocker + ACE inhibitor","E. Beta blocker + CCB"],
answer: `B. ACE inhibitor + CCB`,
explanation:`Kombinasi yang tepat menurut tatalaksana yaitu ACEI Inhibitor + CCB<img src="assets/01TO1M11.jpeg"></img<p><strong>Referensi:</strong></p><ol><li>Lukito AA, Harmeiwaty E, Hustrini NM, editors. Konsensus Penatalaksanaan Hipertensi 2019. Jakarta: Perhimpunan Dokter Hipertensi Indonesia; 2019.</li><li>Keputusan Menteri Kesehatan Republik Indonesia Nomor HK 01.07/Menkes/4634/2021 Tentang Pedoman Nasional Pelayanan Kedokteran Tata Laksana Hipertensi Dewasa</li></ol>`,
expImg:``
},
{
category:`Gangguan kardiovaskuler`,
level:`Medium`,
question:`<p>Seorang pasien, laki-laki, usia 25 tahun, dibawa ke IGD karena ditemukan tidak responsif sekitar 30 menit setelah menyuntikkan zat yang diduga merupakan narkotika. Hasil pemeriksaan menunjukkan tekanan darah 90/60 mmHg, frekuensi nadi 58 kali/menit, frekuensi napas 6 kali/menit, saturasi oksigen 82%, dan pupil tampak sangat kecil (<em>pinpoint pupil</em>). Dokter mendiagnosis pasien mengalami overdosis opioid dan meminta rekomendasi apoteker mengenai antidotum yang tepat untuk diberikan. Apakah antidotum yang tepat direkomendasikan?</p>`,
img:``,
...
category:`Gangguan kardiovaskuler`,
level:`Easy`,
question:`Seorang pasien, laki-laki, usia 58 tahun, dirawat di unit perawatan intensif (<em>Intensive Care Unit</em>/ICU) dengan diagnosis syok sepsis sekunder akibat pneumonia berat. Hasil pemantauan tanda vital menunjukkan tekanan darah 80/50 mmHg, frekuensi nadi 115 kali/menit, dan suhu tubuh 38,5°C. Dokter telah memberikan resusitasi cairan kristaloid sebanyak 30 mL/kgBB, namun kondisi hemodinamik pasien belum stabil. Dokter berdiskusi dengan apoteker mengenai penambahan terapi vasopresor untuk mencapai target tekanan darah. Apakah vasopresor lini pertama yang tepat direkomendasikan? (UKMPPAI FEBRUARI 2025)`,
img:``,
...
category:`Gangguan kardiovaskuler`,
level:`Hard`,
question:`<p>Seorang pasien, laki-laki, usia 58 tahun, dibawa ke IGD karena nyeri dada kiri menjalar ke lengan dan punggung sejak 2 jam yang lalu. Hasil pemeriksaan EKG menunjukkan adanya elevasi segmen ST yang signifikan. Karena fasilitas<em> Percutaneous Coronary Intervention</em> (PCI) tidak tersedia dan jarak ke pusat rujukan terlalu jauh, dokter memutuskan untuk segera memberikan terapi fibrinolitik dengan tenecteplase. Apoteker melakukan penelusuran riwayat medis pasien untuk memastikan keamanan terapi sebelum obat diberikan. Apakah data klinis pasien yang merupakan kontraindikasi absolut penggunaan terapi tersebut?</p>`,
img:``,
options:["A. Aspirin 80 mg/hari yang sedang dikonsumsi","B. Perdarahan intrakranial yang pernah dialami 2 tahun yang lalu","C. Riwayat stroke iskemik yang terjadi 8 bulan yang lalu","D. Tekanan darah saat masuk 170/100 mmHg","E. Ulkus peptikum yang pernah dialami 1 tahun yang lalu"],
answer: `B. Perdarahan intrakranial yang pernah dialami 2 tahun yang lalu`,
...
category:`Gangguan kardiovaskuler`,
level:`Easy`,
question:`<p>Seorang pasien, laki-laki, usia 62 tahun, dibawa ke IGD dengan keluhan kelemahan anggota gerak sebelah kanan secara mendadak disertai bicara pelo (<em>disartria</em>) sejak 2 jam yang lalu. Hasil pemeriksaan CT-scan kepala menunjukkan adanya infark serebri tanpa tanda perdarahan. Tekanan darah pasien saat masuk adalah 165/95 mmHg dan pasien memiliki riwayat hipertensi rutin dengan lisinopril 10 mg sekali sehari. Dokter memutuskan untuk segera memberikan terapi trombolitik menggunakan Alteplase (r-tPA). Setelah infus Alteplase selesai diberikan, dokter berdiskusi dengan apoteker mengenai rencana inisiasi terapi antiplatelet aspirin pada pasien tersebut. Apakah waktu pemberian aspirin yang tepat direkomendasikan?</p>`,
img:``,
options:["A. Bersamaan dengan pemberian Alteplase","B. Segera setelah infus Alteplase selesai","C. 6 jam setelah pemberian Alteplase","D. 24 jam setelah pemberian Alteplase","E. 7 hari setelah pemberian Alteplase"],
answer: `D. 24 jam setelah pemberian Alteplase`,
explanation:`<p>Pada pasien yang mendapatkan terapi <strong>alteplase,</strong> pemberian aspirin biasanya <strong><span style="color: #ff0000;">ditunda</span> hingga 24 setelah terapi</strong> untuk mencegah risiko hemoragik. Dengan demikian, jawabannya adalah D. 24 jam setelah pemberian Alteplase.<br /><br /><strong>Referensi:</strong></p><ol><li>Kemenkes RI Nomor Hk.01.07/menkes/394/2019 Tentang Pedoman Nasional Pelayanan Kedokteran Tata Laksana Stroke</li><li>DiPiro's pharmacotherapy: A pathophysiologic approach, 2023, 12th ed. Chapter 34</li></ol>`,
expImg:`06TO1M11.png`
},
{
category:`Gangguan kardiovaskuler`,
level:`Medium`,
question:`<p>Seorang pasien, perempuan, usia 45 tahun, didiagnosis mengalami stroke iskemik akibat kardioemboli yang dipicu oleh fibrilasi atrium (atrial fibrillation). Pasien memiliki riwayat kepatuhan yang rendah terhadap jadwal kontrol rutin. Sebelumnya, pasien menggunakan warfarin namun dihentikan karena mengalami efek samping berupa hematoma akibat nilai INR yang fluktuatif. Dokter meminta rekomendasi apoteker mengenai terapi antikoagulan oral golongan <em>Direct Oral Anticoagulant </em>(DOAC) yang memiliki dosis tetap dan tidak memerlukan pemantauan laboratorium rutin. Apakah obat yang tepat direkomendasikan?</p>`,
img:``,
options:["A. Apiksaban","B. Dabigatran","C. Edoksaban","D. Rivaroksaban","E. Warfarin"],
answer: `A. Apiksaban`,
explanation:`<p>Pasien adalah wanita 45 tahun dengan stroke kardioemboli yang membutuhkan terapi antikoagulan oral untuk pencegahan sekunder. Berdasarkan tabel rekomendasi DiPiro 12th ed., untuk stroke etiologi kardioemboli (terutama akibat fibrilasi atrium), pilihan terapi yang direkomendasikan dengan Class I, Level of Evidence A adalah:</p><ul><li>Vitamin K antagonist (warfarin) dengan target INR 2–3;</li><li>Apixaban 5 mg dua kali sehari;</li><li>Dabigatran 150 mg dua kali sehari;</li><li>Edoxaban 60 mg sekali sehari;</li><li>Rivaroxaban 20 mg sekali sehari.</li></ul><p>Tabel juga secara eksplisit menyatakan bahwa pada pasien dengan fibrilasi atrium tanpa stenosis mitral sedang-berat atau katup jantung mekanik, golongan DOAC (apixaban, dabigatran, edoxaban, atau rivaroxaban) lebih dipilih dibanding warfarin (Class I, Level B-R). Dengan demikian, jawaban yang tepat adalah D. Apixaban.<br /><br /><strong>Referensi:</strong><br />DiPiro's pharmacotherapy: A pathophysiologic approach, 2023, 12th ed. Chapter 34</p>`,
expImg:`07TO1M11.png`
},
{
category:`Gangguan kardiovaskuler`,
level:`Medium`,
question:`<p>Seorang pasien, laki-laki, usia 55 tahun, didiagnosis mengalami <em>ST-elevation myocardial infarction</em> (STEMI) akut dan direncanakan untuk menjalani tindakan Percutaneous Coronary Intervention (PCI). Dokter meresepkan <em>Dual Antiplatelet Therapy</em> (DAPT) sebagai tatalaksana awal menggunakan kombinasi aspirin dan tikagrelor. Namun, stok tikagrelor di instalasi farmasi kosong. Apoteker klinis di IGD berdiskusi dengan dokter untuk memilih alternatif <em>inhibitor P2Y12</em> lain yang memiliki potensi setara untuk menjaga efikasi antitrombotik pasien tersebut. Apakah obat antiplatelet yang tepat direkomendasikan sebagai pengganti tikagrelor? (TO UKMPPAI NOVEMBER 2024)</p>`,
img:``,
options:["A. Prasugrel","B. Cilostazol","C. Dipiridamol","D. Klopidogrel","E. Warfarin"],
answer: `A. Prasugrel`,
explanation:`<p>Ticagrelor dan prasugrel termasuk P2Y12 inhibitor poten generasi ketiga dengan efikasi antiplatelet superior dibanding klopidogrel berdasarkan AHA 2025. Hal ini juga didukung oleh Pedoman Tata Laksana Sindrom Koroner Akut 2024 bahwa utamakan prasugrel atau ticagrelor terlebih dahulu serta gunakan clopidogrel BILA prasugrel dan ticagrelor tidak tersedia. Dengan demikian, jawaban yang tepat adalah A. Prasugrel.<br /><br /><strong>Referensi:</strong></p><ol><li>Perhimpunan Dokter Spesialis Kardiovaskular Indonesia. (2024). Pedoman Tata Laksana Sindrom Koroner Akut (Edisi ke-5). PERKI</li><li>2025 ACC/AHA/ACEP/NAEMSP/SCAI Guideline for the Management of Patients With Acute Coronary Syndromes.</li></ol>`,
expImg:`Rev_02.png`
},
{
category:`Gangguan kardiovaskuler`,
level:`Medium`,
question:`<p>Seorang pasien, laki-laki, usia 64 tahun, dengan riwayat stroke iskemik, dijadwalkan menjalani operasi pengangkatan massa tumor payudara dalam satu minggu ke depan. Pasien rutin mengonsumsi klopidogrel 75 mg satu kali sehari sebagai terapi pencegahan sekunder stroke. Hasil pemeriksaan laboratorium menunjukkan nilai <em>prothrombin time</em> (PT), <em>activated partial thromboplastin time</em> (APTT), dan jumlah trombosit dalam batas normal. Dokter meminta rekomendasi apoteker mengenai durasi penghentian sementara klopidogrel sebelum operasi untuk meminimalkan risiko perdarahan perioperatif. Berapakah durasi penghentian klopidogrel sebelum operasi yang tepat direkomendasikan?</p>`,
img:``,
...
{
category:`Gangguan endokrin`,
level:`Hard`,
question:`<p>Seorang pasien, perempuan, usia 34 tahun, dirawat di RS Nitro Medica dengan diagnosis penyakit <em>Graves</em>. Hasil laboratorium menunjukkan kadar TSH &lt;0,01 mIU/L dan FT4 meningkat. Pasien dijadwalkan untuk menjalani tiroidektomi elektif dalam waktu 2 minggu ke depan. Pasien memiliki riwayat peningkatan enzim transaminase (SGOT/SGPT) yang berat akibat penggunaan obat hepatotoksik sebelumnya. Dokter meminta rekomendasi apoteker mengenai obat antitiroid untuk mencapai kondisi eutiroid sebelum operasi dengan mempertimbangkan risiko hepatotoksisitas yang paling minimal. Apakah obat yang tepat direkomendasikan?</p>`,
img:``,
...
category:`Gangguan endokrin`,
level:`Hard`,
question:`<p>Seorang pasien, perempuan, usia 69 tahun, datang ke RS Nitro Medica dengan keluhan nyeri tulang difus dan riwayat jatuh berulang. Hasil pemeriksaan laboratorium menunjukkan kadar 25-hidroksivitamin D sebesar 9 ng/mL, kalsium serum cenderung rendah, fosfat normal-rendah, dan kadar parathormon (PTH) meningkat. Dokter mendiagnosis pasien mengalami hiperparatiroidisme sekunder akibat defisiensi vitamin D. Apakah mekanisme patofisiologi utama yang menyebabkan peningkatan kadar PTH pada pasien tersebut?</p>`,
img:``,
...
category:`Gangguan endokrin`,
level:`Hard`,
question:`<p>Seorang pasien, laki-laki, usia 61 tahun, dengan riwayat diabetes melitus tipe 2 kontrol ke poli penyakit dalam. Hasil pemeriksaan menunjukkan estimasi laju filtrasi glomerulus (eLFG) 24 mL/menit/1,73 m<sup>2</sup>, rasio albumin-kreatinin urin (UACR) 420 mg/g pada dua kali pemeriksaan, dan kadar HbA1c 7,4%. Pasien saat ini belum menjalani dialisis. Dokter meminta rekomendasi apoteker mengenai terapi antidiabetik yang efektif untuk menurunkan progresivitas penyakit ginjal kronis pada pasien tersebut. Apakah obat yang tepat direkomendasikan?</p>`,
img:``,
...
category:`Gangguan endokrin`,
level:`Hard`,
question:`Seorang laki-laki usia 46 tahun baru didiagnosis diabetes melitus tipe 2 di Rumah Sakit Nitro Medica. Hasil pemeriksaan menunjukkan HbA1c 11,2%, GDP 286 mg/dL, GDS 382 mg/dL, penurunan berat badan cepat dalam 2 bulan, poliuria, polidipsia, dan keton urin positif ringan. Dokter meminta apoteker menelaah pilihan terapi awal. Apakah strategi terapi awal yang paling tepat?`,
img:``,
...
{
category:`Gangguan renal, saluran kemih, obstetri - ginekologi`,
level:`Hard`,
question:`Seorang laki-laki usia 67 tahun datang ke Rumah Sakit Nitro Medica dengan keluhan pancaran urin melemah, perlu mengejan saat berkemih, dan nokturia. Dokter menjelaskan bahwa pembesaran prostat pasien terutama dipengaruhi perubahan hormonal terkait usia. Apoteker diminta menjelaskan mekanisme patofisiologi yang menjadi dasar penggunaan inhibitor 5α-reduktase pada BPH. Apakah mekanisme patofisiologi yang paling tepat?`,
img:``,
...
category:`Gangguan renal, saluran kemih, obstetri - ginekologi`,
level:`Hard`,
question:`Seorang laki-laki usia 72 tahun datang ke Apotek Nitro Farma membawa resep dari dokter setelah didiagnosis BPH. Data klinis: IPSS 18, kualitas hidup terganggu, volume prostat 28 mL, PSA 1,0 ng/mL, tekanan darah terkontrol, dan tidak ada keluhan dominan storage. Pasien ingin obat yang relatif cepat memperbaiki pancaran urin. Apakah terapi yang paling tepat?`,
img:``,
options:["A. Tamsulosin","B. Dutasterid","C. Solifenacin","D. Mirabegron","E. Sildenafil"],
answer: `A. Tamsulosin`,
...
{
category:`Gangguan Imunologi, nutrisi, onkologi dan kondisi gawat darurat`,
level:`Hard`,
...
answer: `D. Transfusi <i>packed red cell</i>`,
...
{
category:`Gangguan saraf dan kesehatan jiwa`,
level:`Hard`,
question:`Seorang perempuan usia 31 tahun datang ke Apotek Nitro Farma dengan keluhan sulit tidur, mudah lelah, berdebar, sulit konsentrasi, sering khawatir berlebihan, dan merasa sedih hampir setiap hari sejak 4 bulan terakhir setelah tekanan pekerjaan meningkat. Pasien tidak menunjukkan gejala psikotik, tidak ada riwayat mania, dan menyangkal ide bunuh diri. Dokter menilai gejala ansietas dan depresinya sama-sama bermakna, tetapi belum memenuhi sindrom penuh gangguan depresi berat maupun gangguan cemas spesifik. Dokter meminta masukan terapi farmakologi yang rasional untuk menghindari ketergantungan obat. Apakah obat yang paling tepat direkomendasikan sebagai terapi utama?`,
img:``,
...
category:`Gangguan saraf dan kesehatan jiwa`,
level:`Hard`,
question:`Seorang laki-laki usia 72 tahun datang ke Rumah Sakit Nitro Medica dengan keluhan sulit memulai tidur dan sering terbangun hampir setiap malam selama 5 minggu. Pasien memiliki riwayat <i>benign prostate hyperplasia</i>, pernah jatuh di kamar mandi 2 bulan lalu, rutin tidur siang 2 jam, dan masih minum kopi pukul 19.00. Tidak ada gejala psikotik, mania, maupun nyeri berat. Keluarga meminta obat tidur yang paling kuat agar pasien cepat tidur. Apakah rekomendasi awal yang paling tepat?`,
img:``,
...
category:`Gangguan saraf dan kesehatan jiwa`,
level:`Hard`,
question:`Seorang laki-laki usia 34 tahun dirawat di <i>Rumah Sakit Nitro Medica</i> karena skizofrenia. Pasien tetap mengalami halusinasi auditorik imperatif, waham kejar, dan beberapa kali mencoba melukai diri walaupun sudah mendapat risperidon dosis adekuat selama 8 minggu dan olanzapin dosis adekuat selama 8 minggu pada periode berbeda. Kepatuhan minum obat terkonfirmasi baik oleh keluarga dan catatan farmasi. Dokter meminta rekomendasi terapi tahap berikutnya. Apakah rekomendasi yang paling tepat?`,
img:``,
...
category:`Gangguan saraf dan kesehatan jiwa`,
level:`Hard`,
question:`Seorang laki-laki usia 47 tahun dibawa ke IGD Rumah Sakit Nitro Medica karena kejang tonik-klonik generalisata terus-menerus selama 7 menit. Gula darah kapiler normal, jalan napas sedang diamankan dan akses intravena sudah tersedia. Dokter meminta apoteker menyiapkan obat intravena lini awal sesuai algoritma status epileptikus. Apakah obat yang tepat untuk pasien tersebut?`,
img:``,
...
category:`Gangguan saraf dan kesehatan jiwa`,
level:`Hard`,
question:`Seorang perempuan usia 46 tahun datang dengan keluhan vertigo berputar singkat selama 20–40 detik setiap kali menoleh di tempat tidur atau menunduk mengambil barang. Tidak ada tinnitus, gangguan pendengaran, kelemahan anggota gerak, diplopia, disartria, atau nyeri kepala hebat mendadak. Pemeriksaan Dix-Hallpike memicu vertigo dan nistagmus torsional yang cepat hilang. Dokter meminta intervensi paling tepat untuk terapi definitif kondisi ini. Intervensi manakah yang paling tepat?`,
img:``,

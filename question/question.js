window.questions = [
  ...
  answer: `C. 480`,
  explanation:`Break Even Point (BEP) = Kuantitas penjualan yang harus dicapai pada tingkat laba yang diinginkan untuk mencapai titik impas (balik modal).<br> <br> Break Even Point (BEP) dalam unit:<br><br><img src="assets/16PTO2.PNG"></img><br><br>Apotek tersebut harus mampu menjual minimal 480 botol suplemen dalam satu bulan untuk mencapai titik impas (Break Even Point). <br> <br> <br> Keterangan:</b><br>1. Fixed Cost (FC) atau Biaya Tetap : Biaya tetap yang dikeluarkan tiap bulan atau tahun, contoh: gaji, sewa gedung, operasional, listrik, biaya marketing/promosi, dan sebagainya.<br>2. Variabel Cost (VC) atau Biaya Tidak Tetap : Biaya yang berubah mengikuti jumlah unit terjual, contoh: pembelian obat, biaya embalase, tuslah, komisi/bonus. <br> <br><b>Referensi:</b><br>Satibi, Rokhman, M. R., & Aditama, H. (2024). Manajemen apotek (Cetakan ke-5). Gadjah Mada University Press.`,
  expImg:``,
  },
  {,
  category:`Manajemen Farmasi`,
  ...
  answer: `B. 3,4 tahun`,
  explanation:`Payback Period (PBP) = waktu yang diperlukan untuk balik modal.<img src="assets/17PTO2.PNG"></img><br> <br><b>Referensi:</b><br>Satibi, Rokhman, M. R., & Aditama, H. (2024). Manajemen apotek (Cetakan ke-5). Gadjah Mada University Press.`,
  expImg:``,
  },
  {,
  category:`Manajemen Farmasi`,
  ...
  answer: `C. 6,0 kali`,
  explanation:`<b>Hitung Pembelian Bersih</b><br>Pembelian Bersih = Pembelian – Diskon Pembelian – Retur Pembelian <br>Pembelian Bersih = 1.800.000.000 – 60.000.000 – 40.000.000<br>Pembelian Bersih = 1.700.000.000 <br><br><b>Hitung Harga Pokok Penjualan (HPP)</b><br> HPP = (Persediaan Awal + Pembelian Bersih) – Persediaan Akhir<br>HPP = (350.000.000 + 1.700.000.000) – 250.000.000<br>HPP = 1.800.000.000<img src="assets/18PTO2.PNG"></img><br><br>*Inventory Turn Over Ratio (TOR) = Perputaran Persediaan. TOR yang baik 8 sampai 12 kali per tahun, semakin kecil TOR maka makin menumpuk sediaan.<br> <br><b>Referensi:</b><br>Satibi, Rokhman, M. R., & Aditama, H. (2024). Manajemen apotek (Cetakan ke-5). Gadjah Mada University Press.`,
  expImg:``,
  },
  {,
  category:`Manajemen Farmasi`,
